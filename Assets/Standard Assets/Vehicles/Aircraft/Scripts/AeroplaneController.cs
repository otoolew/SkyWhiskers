...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_MinEnginePower = 0f;        // The maximum output of the engine.
        [SerializeField] private float m_Lift = 0.005f;               // The amount of lift generated by the aeroplane moving forwards.
        ...
        [SerializeField] private float m_BrakeChangeSpeed = 0.5f;  // The speed with which the brake changes.
        [SerializeField] private float m_ThrottleChangeSpeed = 0.5f;  // The speed with which the throttle changes.
        [SerializeField] private float m_DragIncreaseFactor = 0.002f; // how much drag should increase with speed.
        ...
        public float Brake { get; private set; }                        // The amount of brake being used.
        public float BrakeInput { get; private set; }                     // Whether or not the air brakes are being applied.
        ...
        public float MinEnginePower { get { return m_MinEnginePower; } }    // The maximum output of the engine.
        ...
        public void Move(float rollInput, float pitchInput, float yawInput, float throttleInput, float brakeInput)
        {
        ...
        private void ClampInputs()
        {
            ...
            BrakeInput = Mathf.Clamp(BrakeInput, -1, 1);
        ...
        private void IncreaseThrottle()
        {
            ...
            Mathf.Clamp(Throttle += ThrottleInput * Time.deltaTime * m_ThrottleChangeSpeed, 0, 1);
            EnginePower = Mathf.Clamp(Throttle * m_MaxEnginePower, m_MinEnginePower, m_MaxEnginePower);
            Debug.Log("Engine Power Increase " + EnginePower);
        }
        private void DecreaseThrottle()
        {
            ...
            Mathf.Clamp(Throttle -= BrakeInput * Time.deltaTime * m_BrakeChangeSpeed, 0, 1);
            EnginePower = Mathf.Clamp(Throttle * m_MaxEnginePower, m_MinEnginePower, m_MaxEnginePower);

            Debug.Log("Engine Power Decrease " + EnginePower);        
        }
