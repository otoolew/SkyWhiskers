...
public class AirplaneController : MonoBehaviour {
    [SerializeField] private float m_MaxEnginePower = 10f;        // The maximum output of the engine.
    ...
    [SerializeField] private float m_ZeroLiftSpeed = 100;         // The speed at which lift is no longer applied.
    ...
    [SerializeField] private float m_BrakeChangeSpeed = 0.3f;     // The speed with which the brake changes.
